...
VALUES ('Ваш дом выглядит потрясающе! Я хотел бы его снять.', '2023-09-10', '2023-10-10', NOW(), 1, 1),
       ('Подскажите, какие дополнительные услуги включены в стоимость аренды?', '2023-07-05', '2023-08-20', NOW(), 2,
        2),
       ('Какая сумма залога требуется для аренды вашего дома?', '2023-04-08', '2023-05-30', NOW(), 3, 3);
